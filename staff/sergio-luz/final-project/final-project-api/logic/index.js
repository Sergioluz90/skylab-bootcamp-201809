...
const logic = {
    ...
    updateProfile(id, username, email, skype, age, gender, height, weight, smoker, description, receives, moves, city) {
        ...
        if (smoker != null && typeof smoker !== 'string') throw TypeError(`${smoker} is not a string`)
        ...
        if (typeof receives !== 'boolean') throw TypeError(`${receives} is not a boolean`)
        if (typeof moves !== 'boolean') throw TypeError(`${moves} is not a boolean`)
        ...
        if (smoker != null && !smoker.trim().length) throw new ValueError('surname is empty or blank')
